...
const DEFAULT_AGENTS = [
  ...
  { id: 'newsreporter', name: 'ShareBot67', role: 'News and Trend Specialist', model: 'GPT-5.5', status: 'idle', source: 'OpenClaw', notes: 'Telegram-named news specialist for market/news topics, sourced briefs, trend picks, content angles, and reporter-page workflow improvements.' },
  { id: 'routercoder', name: 'RouterCoder', role: 'OpenRouter Coding Specialist', model: 'OpenRouter Code Models', status: 'idle', source: 'OpenClaw', notes: 'Second coding lane for scoped implementation, debugging, tests, repo inspection, and small refactors with explicit model fallbacks and Penny review.' },
